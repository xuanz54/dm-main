...
/***
 * 该类是一个Spring MVC的控制器类,主要实现Excel导入导出功能。包含导出数据到Excel、导入Excel数据到数据库等功能。 其作用是提供系统Excel数据导入导出的接口,实现数据备份和数据导入。
 */
...
public class ExcelIOController {
    ...
    @Autowired
    private sut.edu.zyp.dormitory.manage.repository.AdminRepository adminRepository;

    @Autowired
    private sut.edu.zyp.dormitory.manage.repository.BuildingRepository buildingRepository;

    @Autowired
    private sut.edu.zyp.dormitory.manage.repository.DormitoryManagerRepository dormitoryManagerRepository;

    @Autowired
    private sut.edu.zyp.dormitory.manage.repository.DormitoryRepository dormitoryRepository;

    @Autowired
    private sut.edu.zyp.dormitory.manage.repository.LiveRepository liveRepository;

    @Autowired
    private sut.edu.zyp.dormitory.manage.repository.StudentRepository studentRepository;
    ...
    private List<Map<String, String>> getDataByUrl(String url) {
        ...
        if ("/admin".equals(url)) {
            ...
            Iterable<sut.edu.zyp.dormitory.manage.entity.BuildingEntity> buildingEntities = buildingRepository.findAll();
            data = addDataToResult(buildingEntities.iterator(), data);
        } else if ("/dormitoryManager".equals(url)) {
            Iterable<sut.edu.zyp.dormitory.manage.entity.DormitoryManagerEntity> dormitoryManagerEntities = dormitoryManagerRepository.findAll();
            data = addDataToResult(dormitoryManagerEntities.iterator(), data);
        } else if ("/dormitory".equals(url)) {
            Iterable<sut.edu.zyp.dormitory.manage.entity.DormitoryEntity> dormitoryEntities = dormitoryRepository.findAll();
            data = addDataToResult(dormitoryEntities.iterator(), data);
        } else if ("/live".equals(url)) {
            Iterable<sut.edu.zyp.dormitory.manage.entity.LiveEntity> liveEntities = liveRepository.findAll();
            data = addDataToResult(liveEntities.iterator(), data);
        } else if ("/student".equals(url)) {
            Iterable<sut.edu.zyp.dormitory.manage.entity.StudentEntity> studentEntities = studentRepository.findAll();
        ...
        try {
            if (file.isEmpty()) {
                ...
                if (data.size() <= 0) {
                    ...
                    List<sut.edu.zyp.dormitory.manage.entity.BuildingEntity> buildingEntityList = JSON.parseArray(JSON.toJSONString(data), sut.edu.zyp.dormitory.manage.entity.BuildingEntity.class);
                    Iterable<sut.edu.zyp.dormitory.manage.entity.BuildingEntity> buildingEntities = buildingRepository.saveAll(buildingEntityList);
                    List<sut.edu.zyp.dormitory.manage.entity.BuildingEntity> successBuildingEntityList = copyIterator(buildingEntities.iterator());
                    ...
                    List<sut.edu.zyp.dormitory.manage.entity.DormitoryManagerEntity> dormitoryManagerEntityList = JSON.parseArray(JSON.toJSONString(data), sut.edu.zyp.dormitory.manage.entity.DormitoryManagerEntity.class);
                    Iterable<sut.edu.zyp.dormitory.manage.entity.DormitoryManagerEntity> dormitoryManagerEntities = dormitoryManagerRepository.saveAll(dormitoryManagerEntityList);
                    List<sut.edu.zyp.dormitory.manage.entity.DormitoryManagerEntity> successDormitoryManagerEntityList = copyIterator(dormitoryManagerEntities.iterator());
                    ...
                    List<sut.edu.zyp.dormitory.manage.entity.DormitoryEntity> dormitoryEntityList = JSON.parseArray(JSON.toJSONString(data), sut.edu.zyp.dormitory.manage.entity.DormitoryEntity.class);
                    Iterable<sut.edu.zyp.dormitory.manage.entity.DormitoryEntity> dormitoryEntities = dormitoryRepository.saveAll(dormitoryEntityList);
                    List<sut.edu.zyp.dormitory.manage.entity.DormitoryEntity> successDormitoryEntityList = copyIterator(dormitoryEntities.iterator());
                    ...
                    List<sut.edu.zyp.dormitory.manage.entity.LiveEntity> liveEntityList = JSON.parseArray(JSON.toJSONString(data), sut.edu.zyp.dormitory.manage.entity.LiveEntity.class);
                    Iterable<sut.edu.zyp.dormitory.manage.entity.LiveEntity> liveEntities = liveRepository.saveAll(liveEntityList);
                    List<sut.edu.zyp.dormitory.manage.entity.LiveEntity> successLiveEntityList = copyIterator(liveEntities.iterator());
                    ...
                    List<sut.edu.zyp.dormitory.manage.entity.StudentEntity> studentEntityList = JSON.parseArray(JSON.toJSONString(data), sut.edu.zyp.dormitory.manage.entity.StudentEntity.class);
                    Iterable<sut.edu.zyp.dormitory.manage.entity.StudentEntity> studentEntities = studentRepository.saveAll(studentEntityList);
                    List<sut.edu.zyp.dormitory.manage.entity.StudentEntity> successStudentEntityList = copyIterator(studentEntities.iterator());
